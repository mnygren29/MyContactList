using Prism;
using Prism.Ioc;
using MyContactList.ViewModels;
using MyContactList.Views;
using Xamarin.Forms;
using Xamarin.Forms.Xaml;
using MyContactList.Interfaces;
using MyContactList.Services;
...
namespace MyContactList
{
    public partial class App
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<PrismBaseTabbedPage, PrismBaseTabbedPageViewModel>();
