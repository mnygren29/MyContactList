...
{
    public class PickerBorrowerBehavior : Behavior<Picker>

    {
        ...
        //    BindableProperty.Create(nameof(ValidColor), typeof(Color), typeof(PickerBorrowerBehavior), Color.Default);
        ...
        //    BindableProperty.Create(nameof(InvalidColor), typeof(Color), typeof(PickerBorrowerBehavior), Color.Red);
        ...
        static readonly BindableProperty IsValidProperty =
            ...
            BindableProperty.Create(nameof(IsValid), typeof(bool), typeof(PickerBorrowerBehavior), false);
